...
<body>
 ...
 <!-- Navigation -->
	...
	%>
	<div id="thedropdown">
		<form id="deleting" action="DeleteFromDB" method="post">
			<select name="delete" onchange="this.form.submit()">
				<option selected="selected" style="display: none">Select a
					Character to Delete</option>
				<%
					for (int i = 0; i < Dew.charList.size(); i++) {
						Player playerToDelete = Dew.charList.get(i);
				%>
				<option><%= playerToDelete.getCharID() %></option>
				<%
					}
