...
<table style="margin-left:30px">
		<tr>
			<th>Hero List</th>
			<th>See the players entered so far</th>
		</tr>
	...
	%>
	<div id="thedropdown">
		<form id="updating" action="Update" method="post">
			<select name="update" onchange="this.form.submit()">
				<option selected="selected" style="display: none">Select a
					Character to Update</option>
				<%
					for (int i = 0; i < Dew.charList.size(); i++) {
						Player playerToUpdate = Dew.charList.get(i);
				%>
				<option><%= playerToUpdate.getCharName() %></option>
				<%
					}
			...
			<div class="update-group">
                ...
                <div class="update-group">
                    Attack:
                    <input type="text" class="form-control" name="hitpoints">
                </div><br>
